...
--7.Find all the movies/TV shows by director 'Rajiv Chilaka'!
	...
	SELECT * FROM netflix
    WHERE director ILIKE '%Rajiv Chilaka%' --ILIKE is preffered over LIKE because LIKE is case sensetive but ILIKE is selects both uppercase & lowercase chars. 
